                ...
                <div className="container pb-4">
                    ...
                    <div className="row people">
                        <div className="col-md-6 col-lg-4 item">
                            ...
                            <div className="author"><img className="rounded-circle" src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.reuters.com%2Fbusiness%2Faerospace-defense%2Fairbus-ceo-says-focusing-evolving-existing-portfolio-2021-06-10%2F&psig=AOvVaw3whcaqvJrXeweuR0ofsARy&ust=1635836324380000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCLD3oa3L9vMCFQAAAAAdAAAAABAD" />
                        ...
                        <div className="col-md-6 col-lg-4 item">
                            ...
                            <div className="author"><img className="rounded-circle" src="https://i.imgur.com/o5uMfKo.jpg" />
