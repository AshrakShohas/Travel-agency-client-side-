        ...
        <div>
            ...
            <div className="testimonials-clean">
                <div className="container pb-4">
                    <div className="intro">
                        <h2 className="text-center">Endorsement </h2>
                    ...
                    <div className="row people">
                        <div className="col-md-6 col-lg-4 item">
                            ...
                            <div className="author"><img className="rounded-circle" src="https://cloudfront-us-east-2.images.arcpublishing.com/reuters/RTMSHOUSGFKQJC2VCUOFXZCHXM.jpg" />
                        ...
                        <div className="col-md-6 col-lg-4 item">
                            ...
                            <div className="author"><img className="rounded-circle" src="https://www.nippon.com/en/ncommon/contents/news/125242/125242.jpg" />
                                <h5 className="name text-white">Cha Ang</h5>
                                <p className="title text-white">Founder of Style Co.</p>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-4 item">
                            <div className="box">
                            ...
                            <div className="author"><img className="rounded-circle" src="https://miro.medium.com/max/800/1*BrdQWmz3d1jhwbD3BE4WmQ.jpeg" />
                                <h5 className="name text-white">Emi chu Young</h5>
                                <p className="title text-white">Owner of Creative Ltd.</p>
                            </div>
                        </div>
                    </div>
                </div>
