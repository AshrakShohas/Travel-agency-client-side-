                ...
                <div className="col col1">
                    <div className="card p-2 h-100">
                        ...
                        <div className="card-body">
                            ...
                            <p className="card-text">TTravel guides plan, sell, and arrange tours for groups or individuals that are normally at long distances from their customer's homes. ... These professionals also handle the group's transportation, accommodations, and even meals and more often than not travels with the group and stays in the same accommodations.</p>
                        </div>
                    </div>
                </div>
                <div className="col col1">
