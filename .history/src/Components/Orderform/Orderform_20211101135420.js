...
const Orderform = () => {
    ...
    const onSubmit = formData => {
        ...
        axios.post('https://chilling-crypt-39330.herokuapp.com/orders', data)
            .then(res => {
    ...
    return (
        <div>
            ...
            <form className="order-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                <input className=" m-2 Order text-white  btn-danger btn-outline-none text-uppercase fw-bold " value="Order" type="submit" />
            </form>
        </div>
    );
};
